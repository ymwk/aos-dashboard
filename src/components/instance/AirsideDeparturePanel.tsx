...
export const AirsideDeparturePanel: React.FC = () => {
  return (
    <Panel>
      <PanelHeader>
        <i className="ic-comm i--departure-g"></i>
        Departure
      </PanelHeader>
      <PanelBody>
        <table className="table-panel table-airside">
          ...
          <tbody>
            <tr>
              ...
              <td>4</td>
              <td>
                <ProgressChart total={106} value={85} type="airside" />
              </td>
              <td>1</td>
            </tr>
            <tr>
              ...
              <td>4</td>
              <td>
                <ProgressChart total={46} value={20} type="airside" />
              </td>
              <td>1</td>
            </tr>
          </tbody>
