  ...
  return (
    <Panel className="grid-3">
      <div className={classes.terminal}>
        <i className="ic-comm i--t1-g" />
        <div className={classes.contarea}>
          <div className={classes.circle}>
            <div className={classes.circleCont}>
              <span className={classes.title}>T1</span>
              <div className={classes.map}>
                <div className={classes.num}>
                  <span className={classes.state}>1</span>
                  <span className={classes.state}>2</span>
                  <span className={`${classes.state} ${classes.step2}`}>3</span>
                  <span className={`${classes.state} ${classes.step2}`}>4</span>
                  <span className={classes.state}>5</span>
                  <span className={`${classes.state} ${classes.step3}`}>6</span>
                </div>
